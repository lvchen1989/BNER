/*
 * LSTMUnNoCharCRFMMClassifier.h
 *
 *  Created on: 2016-4-4
 *      Author: chen_lyu
 */

#ifndef LSTMUNNOCHARCRFMMCLASSIFIER_H_
#define LSTMUNNOCHARCRFMMCLASSIFIER_H_
...
class LSTMUnNoCharCRFMLClassifier {
public:
  LSTMUnNoCharCRFMLClassifier() {
    _dropOut = 0.5;
  }
  ~LSTMUnNoCharCRFMLClassifier() {
...
#endif /* LSTMUNNOCHARCRFMMCLASSIFIER_H_ */
