/*
 * LSTMNoCharCRFMLClassifier.h
 *
 *  Created on: 2016-4-3
 *      Author: chen_lyu
 */

#ifndef LSTMNOCHARCRFMLCLASSIFIER_H_
#define LSTMNOCHARCRFMLCLASSIFIER_H_
...
class LSTMNoCharCRFMLClassifier {
public:
  LSTMNoCharCRFMLClassifier() {
    _dropOut = 0.5;
  }
  ~LSTMNoCharCRFMLClassifier() {
...
#endif /* LSTMNOCHARCRFMLCLASSIFIER_H_ */
